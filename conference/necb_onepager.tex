...
\setlength{\topsep}{2pt}
  ...
  \item Independently trained SAE dictionaries: including one binder-target co-attention context via ESM-C's native chain-break token converges on the same residues in real proteins for a subset of examined features, corroborated by InterPro domain annotations and calibrated LLM-assisted labeling.
